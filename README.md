A simple python django web app (candidates list) with database which stores data that is demonstrated on web app pages and admin page that can be used to edit that data.
